...
type DPFHCPProvisionerSpec struct {
	...
	// This field is required for ignition generation to retrieve DPU flavor information
	// This field is immutable.
...
type DPFHCPProvisionerStatus struct {
	...
	// IgnitionGenerationRetryCount tracks the number of ignition generation retries
